...
//
// $hash=38689fe14345dd2dbd9c1398d4ba970a82389a8b$
//
...
enum CefWrapperType {
  ...
  WT_AUDIO_HANDLER,
  WT_AUTH_CALLBACK,
  WT_AUTH_PROFILE_VISITOR,
  WT_AUTH_VAULT,
  WT_AUTH_VAULT_ACTION_CALLBACK,
  WT_AUTH_VAULT_READ_CALLBACK,
  WT_AUTOMATION_PROGRAM,
  WT_AUTOMATION_PROGRAM_CALLBACK,
  WT_BATCH_QUERY_CALLBACK,
  ...
  WT_BROWSER_SECURITY_CALLBACK,
  WT_BROWSER_SECURITY_POLICY,
  WT_BROWSER_VIEW,
  ...
  WT_COMPOUND_OPERATION_CALLBACK,
  ...
  WT_STORAGE_STATE_ACTION_CALLBACK,
  WT_STORAGE_STATE_LIST_CALLBACK,
  WT_STORAGE_STATE_MANAGER,
  WT_STORAGE_STATE_READ_CALLBACK,
  WT_STREAM_READER,
  WT_STREAM_WRITER,
  WT_STRING_VISITOR,
  WT_TASK,
