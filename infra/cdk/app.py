    ...
    def __init__(
        ...
        **kwargs,
        ...
        x86_user_data.add_commands(
            ...
            "curl -fsSL https://github.com/actions/runner/releases/download/v2.333.1/actions-runner-linux-x64-2.333.1.tar.gz"
            " | tar -xz",
        ...
        arm_user_data.add_commands(
            ...
            "mkdir -p /opt/actions-runner && chown runner:runner /opt/actions-runner",
            "cd /opt/actions-runner",
            "curl -fsSL https://github.com/actions/runner/releases/download/v2.333.1/actions-runner-linux-arm64-2.333.1.tar.gz"
            " | tar -xz",
            "chown -R runner:runner /opt/actions-runner",
